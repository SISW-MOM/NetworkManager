...
{
	NMDeviceBond *self = NM_DEVICE_BOND (device);
	const char *value = _nm_setting_bond_get_option_or_default (s_bond, opt);
...
apply_bonding_config (NMDeviceBond *self)
{
	...
	mode_str = _nm_setting_bond_get_option_or_default (s_bond, NM_SETTING_BOND_OPTION_MODE);
	...
	value = _nm_setting_bond_get_option_or_default (s_bond, NM_SETTING_BOND_OPTION_ARP_IP_TARGET);
               ...
               gboolean configure)
{
	...
	if (configure) {
		...
		if (master_con) {
			...
			if (s_bond) {
				active = _nm_setting_bond_get_option_or_default (s_bond,
...
reapply_connection (NMDevice *device, NMConnection *con_old, NMConnection *con_new)
{
	...
	value = _nm_setting_bond_get_option_or_default (s_bond, NM_SETTING_BOND_OPTION_MODE);
	mode = _nm_setting_bond_mode_from_string (value);
